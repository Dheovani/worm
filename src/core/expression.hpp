...
namespace worm
{
  namespace core
  {
    ...
    {
    public:
      [[nodiscard]] static Expression compare(std::string_view column, Comparison comparison, Parameter value);
      [[nodiscard]] static Expression isNull(std::string_view column);
      [[nodiscard]] static Expression isNotNull(std::string_view column);
      [[nodiscard]] static Expression between(std::string_view column, Parameter lower, Parameter upper);
